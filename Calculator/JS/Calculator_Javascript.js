...
const Calculator = {
    // this displays 0 on the screeen
    Display_Value: '0',
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // if the Display_Value doesn't contain a decimal point we want to add one
...
// define the function of each operand
...
keys.addEventListener('click', (event) => {
    ...
    // ensres that AC clears the numbers from the Calculator
